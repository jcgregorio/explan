...
describe('parseDuration', () => {
  it('handles shorthand durations', () => {
    ...
    assert.equal(isOK(parseDuration('1w1d1m', 5)), 4 * 5 + 5 + 3);
    assert.equal(isOK(parseDuration('1w1d1m', 7)), 4 * 7 + 7 + 3);
    assert.equal(isOK(parseDuration('10d', 7)), 10);
    assert.equal(isOK(parseDuration('10d', 7)), 10);
    assert.equal(isOK(parseDuration('1y', 7)), 364);
    assert.equal(isOK(parseDuration('1y', 5)), 260);
