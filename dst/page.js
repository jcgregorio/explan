...
`;
  ...
  `;
    const updateSelectedTaskPanel = (taskIndex) => {
      ...
      window.setTimeout(() => {
        const input = selectedTaskPanel.querySelector("#task-name");
        input.focus();
        input.select();
      }, 0);
    };
