...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var ActionFromOp = class _ActionFromOp {
    ...
    do(explainMain) {
      ...
      return ok(
        new _ActionFromOp(this.postActionWork, this.undo, ret.value.inverse)
      );
    }
  };
