...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var SplitTaskAction = class {
    ...
    do(explanMain2) {
      ...
      const ret = SplitTaskOp(explanMain2.selectedTask).apply(explanMain2.plan);
      if (!ret.ok) {
        return ret;
      }
      return ok(
  ...
  var DupTaskAction = class {
    ...
    do(explanMain2) {
      ...
      const ret = DupTaskOp(explanMain2.selectedTask).apply(explanMain2.plan);
      if (!ret.ok) {
        return ret;
      }
      return ok(
