...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var criticalTaskFrequencies = (allCriticalPaths, plan2) => {
    ...
    allCriticalPaths.forEach((value) => {
      value.tasks.forEach((taskIndex) => {
        ...
        if (taskEntry === void 0) {
          taskEntry = {
            taskIndex,
            duration: plan2.chart.Vertices[taskIndex].duration,
            numTimesAppeared: 0
          };
  ...
  var criticalPathsTemplate = (allCriticalPaths) => x`
  <ul>
...
`;
  var criticalTaskFrequenciesTemplate = (criticalTasksDurationDescending) => x`<tr>
      <th>Name</th>
      <th>Duration</th>
      <th>Frequency (%)</th>
    </tr>
