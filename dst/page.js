  ...
  var SearchTaskPanel = class extends HTMLElement {
    ...
    connectedCallback() {
      ...
      this.addEventListener("task-change", (e2) => {
        this.explanMain.setSelection(e2.detail.taskIndex, e2.detail.focus);
      });
