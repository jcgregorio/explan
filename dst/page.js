...
`;
  ...
  var ExplanMain = class extends HTMLElement {
    ...
    connectedCallback() {
      ...
      this.dependenciesControl.addEventListener("add-dependency", async (e2) => {
