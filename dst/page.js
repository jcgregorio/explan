  ...
  ${Object.keys(task.resources).map(
    ...
    <select>
      ${plan.resourceDefinitions[resourceKey].values.map(
        (resourceValue) => `<option ${resourceValue === task.resources[resourceKey] ? `selected` : ``}>${resourceValue}</option>`
      ).join("\n")}
