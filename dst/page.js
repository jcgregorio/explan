  ...
  var TaskCompletionPanel = class extends HTMLElement {
    ...
    percentChange(e3) {
      ...
      if (dup2.stage === "started") {
        ...
        const ret = this.plan.setTaskCompletion(this.taskIndex, dup2);
        if (!ret.ok) {
          console.log(ret.error);
        }
        this.updateOnInput();
