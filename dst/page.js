...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var template = (selectedTaskPanel, plan, taskIndex) => {
    if (taskIndex === -1) {
  ...
  var SelectedTaskPanel = class extends HTMLElement {
    ...
    taskIndex = -1;
    connectedCallback() {
      B(template(this, this.plan, this.taskIndex), this);
    }
