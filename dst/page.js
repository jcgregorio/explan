...
(() => {
  ...
  function renderTasksToCanvas(parent, canvas, ctx, plan2, spans2, opts, overlay = null) {
    ...
    if (overlay !== null) {
      ...
      updateHighlightFromMousePos2 = (point) => {
  ...
  var mm = new MouseMove(document.querySelector("#overlay"));
