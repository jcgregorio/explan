    ...
    parse(s2) {
      ...
      return ok(
        this.metricDefn.clampAndRound(
          (ret.value.getTime() - this.start.getTime() + 1) / (1e3 * 60 * 60 * 24)
        )
      );
    }
  };
