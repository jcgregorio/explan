...
`;
  ...
  <table>
    ${dependenciesControl.indices.map((taskIndex) => {
...
`;
  var DependenciesControl = class extends HTMLElement {
    ...
    setTasksAndIndices(tasks, indices) {
      this.tasks = tasks;
...
`;
  ...
  var ExplanMain = class extends HTMLElement {
    ...
    focusOnTask = false;
    mouseMove = null;
    dependenciesControlPred = null;
    dependenciesControlSucc = null;
