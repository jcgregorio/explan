    ...
    <table>
      ...
      ([resourceKey, defn]) => x` <tr>
            ...
            <td>
              <select
                id="${resourceKey}"
                @change=${(e2) => explainMain.taskResourceValueChanged(
...
`;
  ...
  var ExplanMain = class extends HTMLElement {
    ...
    connectedCallback() {
      ...
      const explanMain = this.querySelector("explan-main");
