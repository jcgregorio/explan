...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var spans = [];
  var criticalPath = [];
  var recalculateSpansSlacksAndCriticalPath = () => {
    let slacks = [];
