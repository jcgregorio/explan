...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var buildSelectedTaskPanel = (plan, selectedTaskPanel) => {
...
`;
  ...
  var ExplanMain = class extends HTMLElement {
    ...
    topTimeline = false;
    groupByOptions = [];
    // ["", ...Object.keys(plan.resourceDefinitions)];
