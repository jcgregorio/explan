...
`;
  ...
  var EditResourcesDialog = class extends HTMLElement {
    ...
    delButtonIfNotStatic(name, isStatic) {
      ...
      return x`<button class=icon-button @click=${() => this.deleteResource(name)}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
    ...
    editButtonIfNotStatic(name, isStatic) {
      ...
      return x`<button class=icon-button @click=${() => this.editResource(name)}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
