  ...
  var EditMetricDefinition = class extends HTMLElement {
    ...
    template() {
      ...
      <table>
        ...
        <tr>
          <th>Precision</th>
          <td><input .value=${l2(defn.precision.precision)} /></td>
          <td></td>
        </tr>
        <tr>
          <th>Default</th>
