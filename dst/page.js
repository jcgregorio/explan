...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  var GoToSearchAction = class {
    ...
    undo = false;
    do(_explanMain) {
      document.querySelector("search-task-panel").setKeyboardFocusToInput();
      return ok(this);
    }
  };
...
`;
  var searchStringFromTask = (task) => task.name;
